...
const Footer = () => {
  ...
  return (
    <footer className='w-full border-t-2 border-solid border-dark font-medium text-lg dark:text-light dark:border-light lg:text-sm bottom-0'>
      <Layout className='!py-8 flex items-center gap-3 sm:flex-col lg:!py-4 md:gap-0'>
        <span className='felx-1 w-full md:text-center'>
